            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="md:col-span-1">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  A modern multi-vendor marketplace built with Next.js and Express. 
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li><Link href="/products" className="text-white/70 hover:text-white transition-colors text-sm">Browse Products</Link></li>
                  <li><Link href="/categories" className="text-white/70 hover:text-white transition-colors text-sm">Categories</Link></li>
                  <li><Link href="/shops" className="text-white/70 hover:text-white transition-colors text-sm">Featured Shops</Link></li>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li><Link href="/dashboard/shop" className="text-white/70 hover:text-white transition-colors text-sm">Start Selling</Link></li>
                  <li><Link href="/seller-guide" className="text-white/70 hover:text-white transition-colors text-sm">Seller Guide</Link></li>
                  <li><Link href="/pricing" className="text-white/70 hover:text-white transition-colors text-sm">Pricing</Link></li>
                  <li><Link href="/support" className="text-white/70 hover:text-white transition-colors text-sm">Support</Link></li>
                </ul>
              </div>
            ...
            <div className="border-t border-white/10 mt-8 pt-6">
              <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                <p className="text-white/60 text-sm">
                  © 2024 Zerina. All rights reserved.
                </p>
