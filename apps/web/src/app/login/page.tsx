...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
      ...
      {/* Subtle marketplace/vendor silhouette overlay */}
      <div aria-hidden className="pointer-events-none absolute inset-0 z-0">
        {/* Animated SVG ornaments from /public/svgs */}
        <img src="/svgs/1.svg" alt="" className="absolute opacity-[0.20] animate-float-slow select-none"
             style={{ top: '6%', left: '4%', width: '220px' }} />
        <img src="/svgs/2.svg" alt="" className="absolute opacity-[0.18] animate-drift select-none"
             style={{ bottom: '10%', left: '12%', width: '260px' }} />
        <img src="/svgs/3.svg" alt="" className="absolute opacity-[0.16] animate-float select-none"
             style={{ top: '12%', right: '8%', width: '280px' }} />
        {/* Swap positions: 5.svg to bottom-right, 4.svg to center */}
        <img src="/svgs/5.svg" alt="" className="absolute opacity-[0.12] animate-float select-none hidden md:block"
             style={{ bottom: '6%', right: '4%', width: '320px', background: 'transparent', mixBlendMode: 'multiply' as any }} />
        <img src="/svgs/4.svg" alt="" className="absolute opacity-[0.14] animate-drift-slow select-none"
             style={{ top: '40%', left: '50%', transform: 'translateX(-50%)', width: '360px', background: 'transparent', mixBlendMode: 'multiply' as any }} />
        {/* Newly added SVGs */}
        <img src="/svgs/7.svg" alt="" className="absolute opacity-[0.10] animate-drift-slow select-none hidden sm:block"
             style={{ top: '18%', left: '18%', width: '260px', background: 'transparent', mixBlendMode: 'multiply' as any }} />
        <img src="/svgs/8.svg" alt="" className="absolute opacity-[0.12] animate-float select-none hidden lg:block"
             style={{ bottom: '18%', left: '50%', transform: 'translateX(-50%)', width: '300px', background: 'transparent', mixBlendMode: 'multiply' as any }} />
        <img src="/svgs/9.svg" alt="" className="absolute opacity-[0.08] animate-float-slow select-none hidden xl:block"
             style={{ top: '8%', right: '24%', width: '340px', background: 'transparent', mixBlendMode: 'multiply' as any }} />
      </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex justify-between items-baseline">
                ...
                <a href="/forgot" className="text-sm text-amber-900/70 hover:text-amber-900">Forgot?</a>
              </div>
              <input
                id="password"
                type="password"
      ...
      <style jsx global>{`
        ...
        @keyframes drift {
          ...
          50% { transform: translateX(8px) translateY(-6px) rotate(0.2deg); }
          100% { transform: translateX(0) translateY(0) rotate(0deg); }
        }
        @keyframes drift-slow {
          0% { transform: translateX(0) translateY(0) rotate(0deg); }
          50% { transform: translateX(-6px) translateY(-4px) rotate(-0.2deg); }
          100% { transform: translateX(0) translateY(0) rotate(0deg); }
        }
